...
def userPrompt():
    ...
    tickerSymbol = tickerSymbolInput()
...
def tickerSymbolInput():
    while True:
        try:
            ...
            if not isTickerSymbolAlpha(tickerSymbol):
                print("Please enter an alphabetic string")
            elif not isTickerSymbolUpper(tickerSymbol):
                print("Please enter an uppercase string")
            elif not isTickerSymbolLengthValid(tickerSymbol):
